...
use xphysics::{
    Body, BodyDef, BodyId, BodyType, FixtureDef, ShapeChain, ShapeEdge, ShapePolygon, World,
};
...
impl<T: Real> TestImpl<T> for CharacterCollision {
    fn new(world: &mut World<T, ()>) -> CharacterCollision {
        ...
        world.create_body_with_fixture(
            BodyDef {
                position: Vector2::new(T::f32(-10.0), T::f32(4.0)),
                ..BodyDef::default()
            },
            FixtureDef::new(
                ShapeChain::create_loop(vec![
        ...
        world.create_body_with_fixture(
            BodyDef {
                position: Vector2::new(T::f32(-3.0), T::f32(8.0)),
